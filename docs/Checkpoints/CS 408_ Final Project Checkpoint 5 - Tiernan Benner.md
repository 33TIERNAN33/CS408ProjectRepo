...
[Github V5 Tag](https://github.com/33TIERNAN33/CS408ProjectRepo/releases/tag/v5)  
[Project Live Demo URL](http://54.245.50.134)

## Task 2:

Below is the output of my git diff between v4 and v5:  
$ git diff \--shortstat v4 v5  
 23 files changed, 953 insertions(+), 55 deletions(-)
...
* Added a Django migration converting the existing image\_path field into a real file upload field.  
